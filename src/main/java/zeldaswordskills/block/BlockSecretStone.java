...
public class BlockSecretStone extends Block implements IDungeonBlock, IExplodable, ILiftable, ISmashable {
    ...
    public static final String[] names = { "stone", "sandstone_normal", "nether_brick", "stonebrick",
        "cobblestone_mossy", "ice", "cobblestone", "end_stone" }; // 6 = "quartz_block_chiseled"
    ...
    public void onBlockClicked(World world, int x, int y, int z, EntityPlayer player) {
        if (player.getHeldItem() != null && player.getHeldItem()
            ...
            if (!world.isRemote) {
                world
                    .playSoundAtEntity(player, Sounds.ITEM_BREAK, 0.25F, 1.0F / (world.rand.nextFloat() * 0.4F + 0.5F));
    ...
    public float getExplosionResistance(Entity entity, World world, int x, int y, int z, double explosionX,
        ...
        return (world.getBlockMetadata(x, y, z) < 0x8 ? getExplosionResistance(entity)
    ...
    public static Block getBlockFromMeta(int meta) {
        switch (meta & ~0x8) {
            ...
            case 5:
                return Blocks.ice;
            case 6:
                return Blocks.cobblestone; // return Blocks.quartz_block;
            case 7:
