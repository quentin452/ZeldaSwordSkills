...
public class BlockQuakeStone extends Block implements IDungeonBlock, IQuakeBlock, ISmashable {
    ...
    public BlockWeight getSmashWeight(EntityPlayer player, ItemStack stack, int meta, int side) {
        return (Config.allowMegaSmashQuakeStone() && PlayerUtils.hasItem(player, ZSSItems.gauntletsGolden)
            ? BlockWeight.VERY_HEAVY
            : BlockWeight.IMPOSSIBLE);
    }
    ...
    public Item getItemDropped(int meta, Random rand, int fortune) {
        return Item.getItemFromBlock(
            BlockQuakeStone.EnumType.byMetadata(meta)
                .getDroppedBlock());
    }
