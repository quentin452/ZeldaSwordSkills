...
public class BlockCeramicJar extends BlockContainer
    implements IExplodable, IHookable, IQuakeBlock, ISmashable, IWhipBlock {
            ...
            if (te instanceof IInventory) {
                ...
                if (inv.getStackInSlot(0) == null && world.rand.nextFloat() < Config.getJarDropChance()) {
                    inv.setInventorySlotContents(
                        0,
                        ChestGenHooks.getInfo(DungeonLootLists.JAR_DROPS)
                            .getOneItem(world.rand));
                }
            }
        ...
        if (!world.isRemote && player.getHeldItem() == null) {
            ...
            if (te instanceof IInventory) {
                ...
                if (invStack != null) {
                    ...
                    jarStack.getTagCompound()
                        .setTag("jarStack", item);
                }
            }
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack stack) {
        if (stack.hasTagCompound() && stack.getTagCompound()
            ...
            TileEntity te = world.getTileEntity(x, y, z);
            if (te instanceof IInventory) {
                ItemStack jarStack = ItemStack.loadItemStackFromNBT(
                    stack.getTagCompound()
                        .getCompoundTag("jarStack"));
    ...
    public void onEntityCollidedWithBlock(World world, int x, int y, int z, Entity entity) {
        if (!world.isRemote && (entity instanceof EntityArrow || entity instanceof EntityBoomerang
            || entity instanceof EntityHookShot)) {
            WorldUtils.playSoundAt(world, x, y, z, Sounds.BREAK_JAR, 0.4F, 0.5F);
            // func_147480_a is destroyBlock
            world.func_147480_a(x, y, z, false);
        }
