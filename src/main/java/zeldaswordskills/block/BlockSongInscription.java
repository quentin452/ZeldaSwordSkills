...
public class BlockSongInscription extends BlockContainer {
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack stack) {
        if (stack.hasTagCompound() && stack.getTagCompound()
            .hasKey("SongName")) {
            AbstractZeldaSong song = ZeldaSongs.getSongByName(
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess world, int x, int y, int z) {
        ...
        switch (world.getBlockMetadata(x, y, z)) {
            case 1:
                setBlockBounds(px2, 1.0F - px1, px2, f, 1.0F, f);
                break;
            case 2:
                setBlockBounds(px2, px2, 0.0F, f, f, px1);
                break;
            case 3:
                setBlockBounds(px2, px2, 1.0F - px1, f, f, 1.0F);
                break;
            case 4:
                setBlockBounds(0.0F, px2, px2, px1, f, f);
                break;
            case 5:
                setBlockBounds(1.0F - px1, px2, px2, 1.0F, f, f);
                break;
            default:
                setBlockBounds(px2, 0.0F, px2, f, px1, f);
                break;
        }
    }
