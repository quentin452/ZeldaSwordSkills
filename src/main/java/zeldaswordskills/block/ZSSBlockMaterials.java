...
public class ZSSBlockMaterials {
    ...
    public static final Material pegWoodMaterial = new AdventureExemptMaterial(MapColor.woodColor).setRequiresTool()
        .setImmovableMobility();

    /** Material used by Rusty Pegs */
    public static final Material pegRustyMaterial = new AdventureExemptMaterial(MapColor.ironColor).setRequiresTool()
        .setImmovableMobility();
