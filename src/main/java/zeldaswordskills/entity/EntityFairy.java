...
public class EntityFairy extends EntityAmbientCreature {
    ...
    protected void collideWithEntity(Entity entity) {
        ...
        if (entity instanceof EntityPlayer) {
            ZSSPlayerInfo.get((EntityPlayer) entity)
                .restoreMagic(0.5F);
        }
    }
    ...
    public void onUpdate() {
         ...
         * worldObj.updateLightByType(EnumSkyBlock.Block, MathHelper.floor_double(posX), MathHelper.floor_double(posY),
         * MathHelper.floor_double(posZ));
         * } else {
         * illuminateBlocks(MathHelper.floor_double(posX), MathHelper.floor_double(posY),
         * MathHelper.floor_double(posZ));
         * }
         */
    }
     ...
     * worldObj.updateLightByType(EnumSkyBlock.Block, MathHelper.floor_double(lastTickPosX),
     * MathHelper.floor_double(lastTickPosY), MathHelper.floor_double(lastTickPosZ));
    ...
    protected void updateAITasks() {
        ...
        } else if (currentFlightTarget == null || rand.nextInt(30) == 0
