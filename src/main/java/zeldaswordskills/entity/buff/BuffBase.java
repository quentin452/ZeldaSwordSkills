    ...
    public void onAdded(EntityLivingBase entity) {
        if (!entity.worldObj.isRemote) {
            ...
            if (entity instanceof EntityPlayerMP) {
                ...
                PacketDispatcher.sendToPlayers(
                    new UpdateBuffPacket(this, entity, false),
        ...
        if (!entity.worldObj.isRemote) {
            ...
            if (needsUpdate) {
                if (entity instanceof EntityPlayerMP) {
                    ...
                    PacketDispatcher.sendToPlayers(
                        new UpdateBuffPacket(this, entity, true),
                        ((WorldServer) entity.worldObj).getEntityTracker()
                            .getTrackingPlayers(entity));
                }
            }
