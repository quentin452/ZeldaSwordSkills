...
public class EntityGoron extends EntityVillager implements IVillageDefender, ISongEntity {
    ...
    private static final MerchantRecipe BIGGORONS_TRADE = new MerchantRecipe(
        new ItemStack(ZSSItems.masterOre, 3),
    ...
    public EntityGoron(World world, int profession) {
        ...
        // targetTasks.addTask(3, new EntityAINearestAttackableTarget(this, EntityLiving.class, 0, false, true,
        // IMob.mobSelector));
    }
    ...
    public MerchantRecipeList getRecipes(EntityPlayer player) {
        ...
        if (("Biggoron").equals(this.getCustomNameTag()) && ZSSQuests.get(player)
            .hasCompleted(QuestBiggoronSword.class)) {
    ...
    public boolean interact(EntityPlayer player) {
        ...
        boolean isCured = ZSSPlayerSongs.get(player)
            .hasCuredNpc("Darunia");
    ...
    public boolean onSongPlayed(EntityPlayer player, AbstractZeldaSong song, int power, int affected) {
        if (("Darunia").equals(getCustomNameTag())) {
            ...
            if (song == ZeldaSongs.songSaria) {
                ...
                } else if (ZSSPlayerSongs.get(player)
                    .onCuredNpc("Darunia")) {
                        ...
                        new TimedChatDialogue(
                            ...
                            new ChatComponentTranslation(
                                "chat.zss.song.saria.darunia.2",
                                new ChatComponentTranslation(gift.getUnlocalizedName() + ".name")));
    ...
    public static void doVillagerSpawn(EntityVillager villager, World world) {
        ...
        if (!villager.isChild() && !compound.hasKey("zssFirstJoinFlag")) {
            ...
            if (ratio > 0 && world.rand.nextInt(ratio) == 0) {
                ...
                try {
                    if (world.villageCollectionObj.getVillageList()
                        .isEmpty() || world.villageCollectionObj.findNearestVillage(x, y, z, 32) != null) {
