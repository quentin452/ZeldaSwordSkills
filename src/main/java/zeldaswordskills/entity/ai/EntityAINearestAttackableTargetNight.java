...
public class EntityAINearestAttackableTargetNight extends EntityAINearestAttackableTarget {
    ...
    public EntityAINearestAttackableTargetNight(EntityCreature taskOwner, Class<? extends Entity> targetClass,
        int targetChance, boolean shouldCheckSight, float minLightLevel) {
        this(taskOwner, targetClass, targetChance, shouldCheckSight, false, minLightLevel);
    }

    public EntityAINearestAttackableTargetNight(EntityCreature taskOwner, Class<? extends Entity> targetClass,
        int targetChance, boolean shouldCheckSight, boolean nearbyOnly, float minLightLevel) {
        this(taskOwner, targetClass, targetChance, shouldCheckSight, nearbyOnly, null, minLightLevel);
    }

    public EntityAINearestAttackableTargetNight(EntityCreature taskOwner, Class<? extends Entity> targetClass,
        int targetChance, boolean shouldCheckSight, boolean nearbyOnly, IEntitySelector targetEntitySelector,
        float minLightLevel) {
