...
public class EntityAILevitate extends EntityAIBase {
    ...
    public boolean checkHeight() {
        ...
        int i = 0;
        while (i < y && !entity.worldObj.getBlock(x, y - i, z)
            .getMaterial()
            .isSolid()
            && !entity.worldObj.getBlock(x, y - i, z)
                .getMaterial()
                .isLiquid()) {
            ++i;
        }
    ...
    public void updateTask() {
        entity.motionY += entity.getEntityAttribute(SharedMonsterAttributes.movementSpeed)
            .getAttributeValue();
    }
}
