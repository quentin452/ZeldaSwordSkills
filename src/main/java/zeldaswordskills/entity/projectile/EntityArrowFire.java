...
public class EntityArrowFire extends EntityArrowElemental {
    ...
    public EntityArrowFire(World world, EntityLivingBase shooter, EntityLivingBase target, float velocity,
        float wobble) {
    ...
    protected DamageSource getDamageSource(Entity entity) {
        return new DamageSourceFireIndirect("arrow.fire", this, this.shootingEntity).setProjectile()
            .setMagicDamage();
    }
