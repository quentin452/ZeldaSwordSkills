...
public class EntitySeedShotNetherwart extends EntitySeedShot {
    ...
    public EntitySeedShotNetherwart(World world, EntityLivingBase shooter, EntityLivingBase target, float velocity,
        float wobble) {
    ...
    public DamageSource getDamageSource() {
        return new EntityDamageSourceIndirect("slingshot", this, this.getThrower()).setFireDamage()
            .setProjectile();
    }
}
