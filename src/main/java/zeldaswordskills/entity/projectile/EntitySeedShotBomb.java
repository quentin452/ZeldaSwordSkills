...
public class EntitySeedShotBomb extends EntitySeedShot {
    ...
    public EntitySeedShotBomb(World world, EntityLivingBase shooter, EntityLivingBase target, float velocity,
        float wobble) {
    ...
    public DamageSource getDamageSource() {
        return new DamageSourceBaseIndirect("slingshot", this, this.getThrower()).setExplosion()
            .setProjectile();
    }
    ...
    protected void onImpact(MovingObjectPosition mop) {
        if (mop.entityHit != null) {
            CustomExplosion.createExplosion(
                new EntityBomb(this.worldObj, this.getThrower()),
                this.worldObj,
                this.posX,
                this.posY,
                this.posZ,
            ...
            if (!block.getBlocksMovement(this.worldObj, mop.blockX, mop.blockY, mop.blockZ)) {
                ...
                if (!this.worldObj.isRemote) {
                    CustomExplosion.createExplosion(
                        new EntityBomb(this.worldObj, getThrower()),
                        this.worldObj,
                        this.posX + dx,
                        this.posY + dy,
                        this.posZ + dz,
