...
public class EntitySeedShotDeku extends EntitySeedShot {
    ...
    public EntitySeedShotDeku(World world, EntityLivingBase shooter, EntityLivingBase target, float velocity,
        float wobble) {
    ...
    public DamageSource getDamageSource() {
        return new DamageSourceBaseIndirect("slingshot", this, this.getThrower()).setStunDamage(80, 2, true)
            .setProjectile();
    }
