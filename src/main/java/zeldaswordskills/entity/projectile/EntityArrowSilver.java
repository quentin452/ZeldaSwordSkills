...
public class EntityArrowSilver extends EntityArrowCustom {
    ...
    public EntityArrowSilver(World world, EntityLivingBase shooter, EntityLivingBase target, float velocity,
        float wobble) {
    ...
    protected DamageSource getDamageSource(Entity entity) {
        if (entity instanceof EntityEnderman) {
            return new EntityDamageSource("arrow.silver", (shootingEntity != null ? shootingEntity : this))
                .setProjectile();
        }
        ...
        return (entity instanceof IEntityTeleport ? source.setUnavoidable()
            .setProjectile() : source.setProjectile());
    }
