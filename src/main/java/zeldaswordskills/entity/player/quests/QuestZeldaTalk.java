...
public final class QuestZeldaTalk extends QuestBase {
    ...
    private boolean isFairyOcarina(ItemStack stack) {
        return stack != null && stack.getItem() instanceof ItemInstrument
    ...
    protected boolean onComplete(EntityPlayer player, Object... data) {
        ...
        String chat = (data != null && data.length > 0
            && data[0] instanceof Boolean
            && ((Boolean) data[0]).booleanValue() ? "played" : "return");
