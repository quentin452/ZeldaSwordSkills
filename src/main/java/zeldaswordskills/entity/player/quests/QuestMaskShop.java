...
public class QuestMaskShop extends QuestBase {
    ...
    private boolean isHoldingZeldasLetter(EntityPlayer player) {
        ...
        return stack != null && stack.getItem() == ZSSItems.treasure
            && Treasures.byDamage(stack.getItemDamage()) == Treasures.ZELDAS_LETTER;
    }
    ...
    public IChatComponent getHint(EntityPlayer player, Object... data) {
        if (isComplete(player)) {
            ...
            boolean flag = ZSSQuests.get(player)
        ...
        } else if (ZSSQuests.get(player)
            .hasCompleted(QuestZeldasLetter.class)) {
