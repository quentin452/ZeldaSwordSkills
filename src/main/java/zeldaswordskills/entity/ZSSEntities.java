...
public class ZSSEntities {
    ...
    public static void preInit() {
        ...
        addSpawnLocations(
            EntityChuRed.class,
            BiomeType.getBiomeArray(null, BiomeType.ARID, BiomeType.FIERY, BiomeType.PLAINS));
        addSpawnLocations(
            EntityChuGreen.class,
            BiomeType.getBiomeArray(null, BiomeType.FOREST, BiomeType.JUNGLE, BiomeType.RIVER));
        addSpawnLocations(
            EntityChuBlue.class,
            BiomeType.getBiomeArray(null, BiomeType.COLD, BiomeType.RIVER, BiomeType.TAIGA));
        addSpawnLocations(
            EntityChuYellow.class,
            BiomeType.getBiomeArray(null, BiomeType.ARID, BiomeType.PLAINS, BiomeType.JUNGLE));
        addSpawnLocations(
            EntityDarknut.class,
            BiomeType.getBiomeArray(null, BiomeType.ARID, BiomeType.FIERY, BiomeType.MOUNTAIN, BiomeType.PLAINS));
        addSpawnLocations(
            EntityDarknutMighty.class,
            BiomeType.getBiomeArray(null, BiomeType.ARID, BiomeType.FIERY, BiomeType.MOUNTAIN, BiomeType.PLAINS));
        addSpawnLocations(
            EntityDekuBaba.class,
            BiomeType.getBiomeArray(null, BiomeType.FOREST, BiomeType.JUNGLE, BiomeType.PLAINS, BiomeType.RIVER));
        addSpawnLocations(
            EntityDekuFire.class,
            BiomeType.getBiomeArray(new String[] { "hell" }, BiomeType.FIERY, BiomeType.JUNGLE, BiomeType.PLAINS));
        addSpawnLocations(
            EntityDekuWithered.class,
            BiomeType.getBiomeArray(new String[] { "hell" }, BiomeType.FIERY, BiomeType.ARID, BiomeType.PLAINS));
        addSpawnLocations(EntityFairy.class, BiomeType.getBiomeArray(null, BiomeType.RIVER));
        addSpawnLocations(
            EntityKeese.class,
            BiomeType.getBiomeArray(null, BiomeType.FOREST, BiomeType.PLAINS, BiomeType.MOUNTAIN));
        addSpawnLocations(
            EntityKeeseCursed.class,
            BiomeType.getBiomeArray(null, BiomeType.FIERY, BiomeType.JUNGLE, BiomeType.RIVER));
        addSpawnLocations(
            EntityKeeseFire.class,
            BiomeType.getBiomeArray(null, BiomeType.ARID, BiomeType.FIERY, BiomeType.JUNGLE));
        addSpawnLocations(EntityKeeseIce.class, BiomeType.getBiomeArray(null, BiomeType.COLD, BiomeType.TAIGA));
        addSpawnLocations(
            EntityKeeseThunder.class,
            BiomeType.getBiomeArray(null, BiomeType.ARID, BiomeType.BEACH, BiomeType.MOUNTAIN));
        ...
        addSpawnLocations(
            EntityWizzrobeGale.class,
            BiomeType.getBiomeArray(null, BiomeType.FOREST, BiomeType.MOUNTAIN));
        addSpawnLocations(EntityWizzrobeIce.class, BiomeType.getBiomeArray(null, BiomeType.COLD, BiomeType.TAIGA));
        addSpawnLocations(
            EntityWizzrobeThunder.class,
            BiomeType.getBiomeArray(null, BiomeType.ARID, BiomeType.MOUNTAIN));
    }
    ...
    public static void postInit(Configuration config) {
        ...
        int rate = 0;
        rate = config.get("Mob Spawns", "[Spawn Rate][Chu] Blue Chu spawn rate (0 to disable)[0+]", 10)
            .getInt();
        addSpawnableEntityData(EntityChuBlue.class, EnumCreatureType.monster, 4, 4, rate);
        rate = config.get("Mob Spawns", "[Spawn Rate][Chu] Green Chu spawn rate (0 to disable)[0+]", 10)
            .getInt();
        addSpawnableEntityData(EntityChuGreen.class, EnumCreatureType.monster, 4, 4, rate);
        rate = config.get("Mob Spawns", "[Spawn Rate][Chu] Red Chu spawn rate (0 to disable)[0+]", 10)
            .getInt();
        addSpawnableEntityData(EntityChuRed.class, EnumCreatureType.monster, 4, 4, rate);
        rate = config.get("Mob Spawns", "[Spawn Rate][Chu] Yellow Chu spawn rate (0 to disable)[0+]", 10)
            .getInt();
        addSpawnableEntityData(EntityChuYellow.class, EnumCreatureType.monster, 4, 4, rate);
        rate = config.get("Mob Spawns", "[Spawn Rate][Darknut] Darknut spawn rate (0 to disable)[0+]", 5)
            .getInt();
        addSpawnableEntityData(EntityDarknut.class, EnumCreatureType.monster, 1, 1, rate);
        rate = config.get("Mob Spawns", "[Spawn Rate][Darknut] Mighty Darknut spawn rate (0 to disable)[0+]", 1)
            .getInt();
        addSpawnableEntityData(EntityDarknutMighty.class, EnumCreatureType.monster, 1, 1, rate);
        rate = config.get("Mob Spawns", "[Spawn Rate][Deku Baba] Deku Baba spawn rate (0 to disable)[0+]", 10)
            .getInt();
        addSpawnableEntityData(EntityDekuBaba.class, EnumCreatureType.monster, 1, 3, rate);
        rate = config.get("Mob Spawns", "[Spawn Rate][Deku Baba] Fire Baba spawn rate (0 to disable)[0+]", 2)
            .getInt();
        addSpawnableEntityData(EntityDekuFire.class, EnumCreatureType.monster, 1, 3, rate);
        rate = config.get("Mob Spawns", "[Spawn Rate][Deku Baba] Withered Baba spawn rate (0 to disable)[0+]", 5)
            .getInt();
        addSpawnableEntityData(EntityDekuWithered.class, EnumCreatureType.monster, 1, 3, rate);
        rate = config.get("Mob Spawns", "[Spawn Rate] Fairy (wild) spawn rate (0 to disable)[0+]", 1)
            .getInt();
        ...
        spawnGoron = config
            .get(
                "Mob Spawns",
                "[Spawn Rate] Goron spawn rate, as a ratio of regular villagers to Gorons (0 to disable)[0+]",
                4)
            .getInt();
        // Keese use the #ambient instead of #monster type so they don't count against the total number of mobs that can
        // spawn in a given area
        rate = config.get("Mob Spawns", "[Spawn Rate][Keese] Keese (regular) spawn rate (0 to disable)[0+]", 5)
            .getInt();
        addSpawnableEntityData(EntityKeese.class, EnumCreatureType.ambient, 4, 4, rate);
        rate = config.get("Mob Spawns", "[Spawn Rate][Keese] Cursed Keese spawn rate (0 to disable)[0+]", 1)
            .getInt();
        addSpawnableEntityData(EntityKeeseCursed.class, EnumCreatureType.ambient, 4, 4, rate);
        rate = config.get("Mob Spawns", "[Spawn Rate][Keese] Fire Keese spawn rate (0 to disable)[0+]", 3)
            .getInt();
        addSpawnableEntityData(EntityKeeseFire.class, EnumCreatureType.ambient, 4, 4, rate);
        rate = config.get("Mob Spawns", "[Spawn Rate][Keese] Ice Keese spawn rate (0 to disable)[0+]", 3)
            .getInt();
        addSpawnableEntityData(EntityKeeseIce.class, EnumCreatureType.ambient, 4, 4, rate);
        rate = config.get("Mob Spawns", "[Spawn Rate][Keese] Thunder Keese spawn rate (0 to disable)[0+]", 2)
            .getInt();
        addSpawnableEntityData(EntityKeeseThunder.class, EnumCreatureType.ambient, 4, 4, rate);
        rate = config.get("Mob Spawns", "[Spawn Rate][Octorok] Purple Octorok spawn rate (0 to disable)[0+]", 8)
            .getInt();
        addSpawnableEntityData(EntityOctorok.class, EnumCreatureType.waterCreature, 2, 4, rate);
        rate = config.get("Mob Spawns", "[Spawn Rate][Octorok] Pink Octorok spawn rate (0 to disable)[0+]", 3)
            .getInt();
        addSpawnableEntityData(EntityOctorokPink.class, EnumCreatureType.waterCreature, 1, 2, rate);
        rate = config.get("Mob Spawns", "[Spawn Rate][Wizzrobe] Fire Wizzrobe spawn rate (0 to disable)[0+]", 10)
            .getInt();
        addSpawnableEntityData(EntityWizzrobeFire.class, EnumCreatureType.monster, 1, 1, rate);
        rate = config.get("Mob Spawns", "[Spawn Rate][Wizzrobe] Gale Wizzrobe spawn rate (0 to disable)[0+]", 10)
            .getInt();
        addSpawnableEntityData(EntityWizzrobeGale.class, EnumCreatureType.monster, 1, 1, rate);
        rate = config.get("Mob Spawns", "[Spawn Rate][Wizzrobe] Ice Wizzrobe spawn rate (0 to disable)[0+]", 10)
            .getInt();
        addSpawnableEntityData(EntityWizzrobeIce.class, EnumCreatureType.monster, 1, 1, rate);
        rate = config.get("Mob Spawns", "[Spawn Rate][Wizzrobe] Thunder Wizzrobe spawn rate (0 to disable)[0+]", 10)
            .getInt();
        ...
        for (Class<? extends EntityLiving> entity : defaultSpawnLists.keySet()) {
            ...
            if (defaultBiomes != null && spawnData != null && spawnData.spawnRate > 0) {
                String[] biomes = config
                    .get(
                        "Mob Spawns",
                        String.format(
                            "[Spawn Biomes] List of biomes in which %s are allowed to spawn",
                            entity.getName()
                                .substring(
                                    entity.getName()
                                        .lastIndexOf(".") + 1)),
        ...
        if (f > 0) {
            // won't override entries if added elsewhere first, which gives other mods a chance to register special loot
            // for vanilla mobs
            ...
            LootableEntityRegistry
                .addLootableEntity(EntitySpider.class, f, new ItemStack(Items.spider_eye), new ItemStack(Items.string));
            LootableEntityRegistry.addLootableEntity(
                EntityWitch.class,
                f,
                new ItemStack(ZSSItems.arrowSilver),
                new ItemStack(Items.potionitem, 1, LibPotionID.HEALING.id),
                new ItemStack(Items.potionitem, 1, LibPotionID.SWIFTNESS.id),
                new ItemStack(Items.potionitem, 1, LibPotionID.FIRERESIST.id),
                new ItemStack(Items.potionitem, 1, LibPotionID.WATER_BREATHING.id));
            LootableEntityRegistry.addLootableEntity(
                EntityZombie.class,
                f,
    ...
    private static void addSpawns(Class<? extends EntityLiving> entity, String[] biomes,
        SpawnableEntityData spawnData) {
        for (String name : biomes) {
            BiomeGenBase biome = getBiomeByName(name);
            if (biome != null) {
                EntityRegistry
                    .addSpawn(entity, spawnData.spawnRate, spawnData.min, spawnData.max, spawnData.creatureType, biome);
            } else {
                ZSSMain.logger.warn(
                    String.format(
                        "Unable to find matching biome for %s while adding spawns for %s!",
                        name,
                        entity.getName()
                            .substring(
                                entity.getName()
    ...
    private static void registerEntities() {
        ...
        EntityRegistry.registerModEntity(
            ...
            true);
        EntityRegistry
            .registerModEntity(EntitySwordBeam.class, "swordbeam", ++modEntityIndex, ZSSMain.instance, 64, 10, true);
        EntityRegistry.registerModEntity(EntityBomb.class, "bomb", ++modEntityIndex, ZSSMain.instance, 64, 10, true);
        EntityRegistry.registerModEntity(
            EntityBombosFireball.class,
            "bombos_fireball",
            ++modEntityIndex,
            ZSSMain.instance,
            64,
            ...
            true);
        EntityRegistry
            .registerModEntity(EntityBoomerang.class, "boomerang", ++modEntityIndex, ZSSMain.instance, 64, 10, true);
        EntityRegistry
            .registerModEntity(EntityCyclone.class, "cyclone", ++modEntityIndex, ZSSMain.instance, 64, 10, true);
        EntityRegistry
            .registerModEntity(EntityCeramicJar.class, "jar", ++modEntityIndex, ZSSMain.instance, 64, 10, true);
        EntityRegistry
            .registerModEntity(EntityHookShot.class, "hookshot", ++modEntityIndex, ZSSMain.instance, 64, 10, true);
        EntityRegistry
            .registerModEntity(EntitySeedShot.class, "seedshot", ++modEntityIndex, ZSSMain.instance, 64, 10, true);
        EntityRegistry.registerModEntity(
            EntitySeedShotBomb.class,
            "seedshot_bomb",
            ++modEntityIndex,
            ZSSMain.instance,
            64,
        ...
        EntityRegistry.registerModEntity(
            ...
            true);
        EntityRegistry.registerModEntity(
            EntitySeedShotNetherwart.class,
            "seedshot_netherwart",
            ++modEntityIndex,
            ZSSMain.instance,
            64,
        ...
        EntityRegistry.registerModEntity(
            ...
            true);
        EntityRegistry
            .registerModEntity(EntityThrowingRock.class, "rock", ++modEntityIndex, ZSSMain.instance, 64, 10, true);
        EntityRegistry
            .registerModEntity(EntityArrowBomb.class, "arrow_bomb", ++modEntityIndex, ZSSMain.instance, 64, 20, true);
        EntityRegistry.registerModEntity(
            EntityArrowBombFire.class,
            "arrow_bomb_fire",
            ++modEntityIndex,
            ZSSMain.instance,
            64,
        ...
        EntityRegistry.registerModEntity(
            ...
            true);
        EntityRegistry
            .registerModEntity(EntityArrowFire.class, "arrow_fire", ++modEntityIndex, ZSSMain.instance, 64, 20, true);
        EntityRegistry
            .registerModEntity(EntityArrowIce.class, "arrow_ice", ++modEntityIndex, ZSSMain.instance, 64, 20, true);
        EntityRegistry
            .registerModEntity(EntityArrowLight.class, "arrow_light", ++modEntityIndex, ZSSMain.instance, 64, 20, true);
        EntityRegistry.registerModEntity(
            EntityArrowSilver.class,
            "arrow_silver",
            ++modEntityIndex,
            ZSSMain.instance,
            64,
            ...
            true);
        EntityRegistry
            .registerModEntity(EntityMagicSpell.class, "magicspell", ++modEntityIndex, ZSSMain.instance, 64, 10, true);
        ...
        EntityRegistry
            .registerModEntity(EntityNavi.class, "fairy.navi", ++modEntityIndex, ZSSMain.instance, 80, 3, true);
    ...
    public static void registerRenderers() {
        RenderingRegistry.registerEntityRenderingHandler(
            EntityArrowCustom.class,
            new RenderCustomArrow(new ResourceLocation(ModInfo.ID, "textures/entity/arrow.png")));
        RenderingRegistry.registerEntityRenderingHandler(
            EntityArrowBomb.class,
            new RenderCustomArrow(new ResourceLocation(ModInfo.ID, "textures/entity/arrow_bomb.png")));
        RenderingRegistry.registerEntityRenderingHandler(
            EntityArrowBombFire.class,
            new RenderCustomArrow(new ResourceLocation(ModInfo.ID, "textures/entity/arrow_bomb_fire.png")));
        RenderingRegistry.registerEntityRenderingHandler(
            EntityArrowBombWater.class,
            new RenderCustomArrow(new ResourceLocation(ModInfo.ID, "textures/entity/arrow_bomb_water.png")));
        RenderingRegistry.registerEntityRenderingHandler(
            EntityArrowFire.class,
            new RenderCustomArrow(new ResourceLocation(ModInfo.ID, "textures/entity/arrow_fire.png")));
        RenderingRegistry.registerEntityRenderingHandler(
            EntityArrowIce.class,
            new RenderCustomArrow(new ResourceLocation(ModInfo.ID, "textures/entity/arrow_ice.png")));
        RenderingRegistry.registerEntityRenderingHandler(
            EntityArrowLight.class,
            new RenderCustomArrow(new ResourceLocation(ModInfo.ID, "textures/entity/arrow_light.png")));
        RenderingRegistry.registerEntityRenderingHandler(
            EntityArrowSilver.class,
            new RenderCustomArrow(new ResourceLocation(ModInfo.ID, "textures/entity/arrow_silver.png")));
        RenderingRegistry.registerEntityRenderingHandler(EntityBomb.class, new RenderEntityBomb());
        RenderingRegistry
            .registerEntityRenderingHandler(EntityBombosFireball.class, new RenderSnowball(Items.fire_charge));
        ...
        RenderingRegistry.registerEntityRenderingHandler(
            EntityChuBlue.class,
            new RenderEntityChuElectric(
                new ResourceLocation(ModInfo.ID, "textures/entity/chu_blue.png"),
                new ResourceLocation(ModInfo.ID, "textures/entity/chu_blue_shock.png")));
        RenderingRegistry.registerEntityRenderingHandler(
            EntityChuYellow.class,
            new RenderEntityChuElectric(
                new ResourceLocation(ModInfo.ID, "textures/entity/chu_yellow.png"),
                new ResourceLocation(ModInfo.ID, "textures/entity/chu_yellow_shock.png")));
        RenderingRegistry.registerEntityRenderingHandler(EntityCyclone.class, new RenderNothing());
        RenderingRegistry.registerEntityRenderingHandler(
            EntityDarknut.class,
            new RenderGenericLiving(
                new ModelDarknut(),
                0.5F,
                1.5F,
                ModInfo.ID + ":textures/entity/darknut_standard.png"));
        RenderingRegistry.registerEntityRenderingHandler(
            EntityDarknutMighty.class,
            new RenderGenericLiving(
                new ModelDarknutMighty(),
                0.5F,
                1.5F,
                ModInfo.ID + ":textures/entity/darknut_standard.png"));
        RenderingRegistry.registerEntityRenderingHandler(
            EntityBlackKnight.class,
            new RenderGenericLiving(
                new ModelDarknutMighty(),
                0.5F,
                1.8F,
        ...
        RenderingRegistry.registerEntityRenderingHandler(
            EntityDekuBaba.class,
            new RenderDekuBaba(new ModelDekuBaba(), 0.5F, 1.25F, ModInfo.ID + ":textures/entity/deku_baba.png"));
        RenderingRegistry.registerEntityRenderingHandler(
            EntityDekuFire.class,
            new RenderDekuBaba(new ModelDekuFire(), 0.5F, 1.25F, ModInfo.ID + ":textures/entity/deku_baba.png"));
        RenderingRegistry.registerEntityRenderingHandler(
            EntityDekuWithered.class,
            new RenderDekuBaba(
                new ModelDekuWithered(),
                0.5F,
                1.25F,
                ModInfo.ID + ":textures/entity/deku_withered.png"));
        ...
        RenderingRegistry.registerEntityRenderingHandler(
            EntityGoron.class,
            new RenderGenericLiving(new ModelGoron(), 0.5F, 1.5F, ModInfo.ID + ":textures/entity/goron.png"));
        RenderingRegistry.registerEntityRenderingHandler(
            EntityKeese.class,
            new RenderEntityKeese(new ResourceLocation(ModInfo.ID, "textures/entity/keese.png")));
        RenderingRegistry.registerEntityRenderingHandler(
            EntityKeeseCursed.class,
            new RenderEntityKeese(new ResourceLocation(ModInfo.ID, "textures/entity/keese_cursed.png")));
        RenderingRegistry.registerEntityRenderingHandler(
            EntityKeeseFire.class,
            new RenderEntityKeese(new ResourceLocation(ModInfo.ID, "textures/entity/keese_fire.png")));
        RenderingRegistry.registerEntityRenderingHandler(
            EntityKeeseIce.class,
            new RenderEntityKeese(new ResourceLocation(ModInfo.ID, "textures/entity/keese_ice.png")));
        RenderingRegistry.registerEntityRenderingHandler(
            EntityKeeseThunder.class,
            new RenderEntityKeeseElectric(
                new ResourceLocation(ModInfo.ID, "textures/entity/keese_thunder.png"),
                new ResourceLocation(ModInfo.ID, "textures/entity/keese_thunder_shock.png")));
        ...
        RenderingRegistry.registerEntityRenderingHandler(
            EntityNpcBarnes.class,
            new RenderGenericLiving(
                new ModelBiped(0.0F, 0.0F, 64, 64),
                0.5F,
                1.0F,
                ModInfo.ID + ":textures/entity/npc_barnes.png"));
        RenderingRegistry.registerEntityRenderingHandler(
            EntityNpcMaskTrader.class,
            new RenderGenericLiving(
                new ModelMaskSalesman(),
                0.5F,
                1.0F,
                ModInfo.ID + ":textures/entity/npc_mask_salesman.png"));
        RenderingRegistry.registerEntityRenderingHandler(
            EntityNpcOrca.class,
            new RenderGenericLiving(
                new ModelBiped(0.0F, 0.0F, 64, 64),
                0.5F,
                1.0F,
                ModInfo.ID + ":textures/entity/npc_orca.png"));
        RenderingRegistry.registerEntityRenderingHandler(
            EntityNpcZelda.class,
            new RenderGenericLiving(
                new ModelBiped(0.0F, 0.0F, 64, 64),
                0.5F,
                1.0F,
                ModInfo.ID + ":textures/entity/npc_zelda.png"));
        RenderingRegistry.registerEntityRenderingHandler(
            EntityOctorok.class,
            new RenderEntityOctorok(
                new ModelOctorok(),
                0.7F,
                new ResourceLocation(ModInfo.ID + ":textures/entity/octorok_purple.png")));
        RenderingRegistry.registerEntityRenderingHandler(
            EntityOctorokPink.class,
            new RenderEntityOctorok(
                new ModelOctorok(),
                0.7F,
                new ResourceLocation(ModInfo.ID + ":textures/entity/octorok_pink.png")));
        RenderingRegistry.registerEntityRenderingHandler(EntitySeedShot.class, new RenderSnowball(Items.wheat_seeds));
        RenderingRegistry
            .registerEntityRenderingHandler(EntitySeedShotBomb.class, new RenderSnowball(ZSSItems.bombFlowerSeed));
        RenderingRegistry.registerEntityRenderingHandler(EntitySeedShotCocoa.class, new RenderSnowball(Items.dye, 3));
        RenderingRegistry
            .registerEntityRenderingHandler(EntitySeedShotDeku.class, new RenderSnowball(ZSSItems.dekuNut));
        RenderingRegistry
            .registerEntityRenderingHandler(EntitySeedShotMelon.class, new RenderSnowball(Items.melon_seeds));
        RenderingRegistry
            .registerEntityRenderingHandler(EntitySeedShotNetherwart.class, new RenderSnowball(Items.nether_wart));
        RenderingRegistry
            .registerEntityRenderingHandler(EntitySeedShotPumpkin.class, new RenderSnowball(Items.pumpkin_seeds));
        RenderingRegistry.registerEntityRenderingHandler(EntitySwordBeam.class, new RenderEntitySwordBeam());
        RenderingRegistry
            .registerEntityRenderingHandler(EntityThrowingRock.class, new RenderSnowball(ZSSItems.throwingRock));
        RenderingRegistry.registerEntityRenderingHandler(EntityWhip.class, new RenderEntityWhip());
        RenderingRegistry.registerEntityRenderingHandler(
            EntityWizzrobeFire.class,
            new RenderEntityWizzrobe(
                new ModelWizzrobe(),
                1.0F,
                new ResourceLocation(ModInfo.ID, "textures/entity/wizzrobe_fire.png")));
        RenderingRegistry.registerEntityRenderingHandler(
            EntityWizzrobeGale.class,
            new RenderEntityWizzrobe(
                new ModelWizzrobe(),
                1.0F,
                new ResourceLocation(ModInfo.ID, "textures/entity/wizzrobe_wind.png")));
        RenderingRegistry.registerEntityRenderingHandler(
            EntityWizzrobeIce.class,
            new RenderEntityWizzrobe(
                new ModelWizzrobe(),
                1.0F,
                new ResourceLocation(ModInfo.ID, "textures/entity/wizzrobe_ice.png")));
        RenderingRegistry.registerEntityRenderingHandler(
            EntityWizzrobeThunder.class,
            new RenderEntityWizzrobe(
                new ModelWizzrobe(),
                1.0F,
                new ResourceLocation(ModInfo.ID, "textures/entity/wizzrobe_lightning.png")));
        RenderingRegistry.registerEntityRenderingHandler(
            EntityWizzrobeGrand.class,
            new RenderEntityWizzrobeGrand(new ModelWizzrobe(), 1.5F));
    }

    /**
     * Registers a tracked entity with only one variety using the given colors for the spawn egg
     */
    public static void registerEntity(Class<? extends EntityLiving> entityClass, String name, int modEntityIndex,
        int trackingRange, int primaryColor, int secondaryColor) {
     ...
     */
    private static void addSpawnableEntityData(Class<? extends EntityLiving> entity, EnumCreatureType creatureType,
        int min, int max, int spawnRate) {
        if (spawnableEntityData.containsKey(entity)) {
            ZSSMain.logger.warn(
                "Spawnable entity " + entity.getName()
                    .substring(
                        entity.getName()
                            .lastIndexOf(".") + 1)
                ...
                ZSSMain.logger.warn(
                    entity.getName()
                        .substring(
                            entity.getName()
                                .lastIndexOf(".") + 1)
                        + " already has an array of default spawn locations!");
            } else {
