...
public class ItemDrinkable extends Item {
    ...
    public static class ItemLonLonSpecial extends ItemDrinkable {
        ...
        public ItemStack onEaten(ItemStack stack, World world, EntityPlayer player) {
            ...
            ZSSEntityInfo.get(player)
                .applyBuff(Buff.UNLIMITED_MAGIC, 1200, 0);
    ...
    public static class ItemPotionPurple extends ItemDrinkable {
        ...
        public ItemStack onEaten(ItemStack stack, World world, EntityPlayer player) {
            ...
            player.getFoodStats()
                .addStats(restore_hunger, saturation);
            return super.onEaten(stack, world, player);
        }
        ...
        public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean isHeld) {
            list.add(
                EnumChatFormatting.GREEN
                    + StatCollector.translateToLocalFormatted("tooltip.zss.restore_stamina", restore_hunger));
        }
    }
}
