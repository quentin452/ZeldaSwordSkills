...
public class ItemSkillOrb extends Item implements IUnenchantable {
    ...
    public String getItemStackDisplayName(ItemStack stack) {
        ...
        return StatCollector
            .translateToLocalFormatted(getUnlocalizedName() + ".name", (skill == null ? "" : skill.getDisplayName()));
    }
    ...
    public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean par4) {
        if (SkillBase.doesSkillExist(stack.getItemDamage())) {
            SkillBase skill = ZSSPlayerSkills.get(player)
                .getPlayerSkill(SkillBase.getSkill(stack.getItemDamage()));
