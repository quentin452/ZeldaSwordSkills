...
/**
 * 
 * Spawn eggs for custom mod entities, using {@link CustomEntityList#addMapping(Class, String, Integer...)
 * CustomEntityList.addMapping}
...
public class ItemCustomEgg extends Item implements IRightClickEntity, IUnenchantable {
    ...
    public void getSubItems(Item item, CreativeTabs tab, List itemList) {
        Iterator<Class<? extends Entity>> iterator = CustomEntityList.entityEggs.keySet()
            .iterator();
