...
public abstract class AnimationWaveTimed extends AnimationWave {
     ...
     */
    public AnimationWaveTimed(RotationAxis axis, int startFrame, int endFrame, float speed, float magnitude,
        float frequency, ModelRenderer... parts) {
    ...
    public static class AnimationWaveTimedSin extends AnimationWaveTimed {
        ...
        public AnimationWaveTimedSin(RotationAxis axis, int startFrame, int endFrame, float speed, float magnitude,
            float frequency, ModelRenderer... parts) {
    ...
    public static class AnimationWaveTimedCos extends AnimationWaveTimed {
        ...
        public AnimationWaveTimedCos(RotationAxis axis, int startFrame, int endFrame, float speed, float magnitude,
            float frequency, ModelRenderer... parts) {
            super(axis, startFrame, endFrame, speed, magnitude, frequency, parts);
        }
