...
public class AnimationTargetAngle extends AnimationTimed {
     ...
     */
    public AnimationTargetAngle(ModelRenderer part, RotationAxis axis, float targetAngle, int startFrame,
        int endFrame) {
    ...
    /**
     * Returns the amount to add to the rotation angle based on the current value and
