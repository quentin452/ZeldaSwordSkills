...
public interface IAnimation {
    ...
    public static class Helper {
         ...
         */
        public static boolean applyAnimation(@Nullable Collection<IAnimation> animations, int frame, float partialTick,
            float speed, float multiplier, float offset, boolean invert) {
            boolean flag = false;
            if (animations != null) {
         ...
         */
        public static boolean applyAnimation(IAnimation animation, int frame, float partialTick, float speed,
            float multiplier, float offset, boolean invert) {
            if (animation.shouldApply(frame, partialTick, speed)) {
                animation.apply(frame, partialTick, speed, multiplier, offset, invert);
                return true;
            }
