...
public abstract class AnimationWave extends AnimationBase {
    ...
    /**
     * Base rotation amount that will be applied per frame if magnitude is 1.0F, equivalent to 22.5 degrees and chosen
     ...
     */
    protected abstract void applyRotationToPart(int index, float progress, float speed, float multiplier, float offset,
        boolean invert);
    ...
    public static class AnimationWaveSin extends AnimationWave {
        ...
        public AnimationWaveSin(RotationAxis axis, float speed, float magnitude, float frequency,
            ModelRenderer... parts) {
            super(axis, speed, magnitude, frequency, parts);
        }

        @Override
        protected void applyRotationToPart(int index, float progress, float speed, float multiplier, float offset,
            boolean invert) {
    ...
    public static class AnimationWaveCos extends AnimationWave {
        ...
        public AnimationWaveCos(RotationAxis axis, float speed, float magnitude, float frequency,
            ModelRenderer... parts) {
            super(axis, speed, magnitude, frequency, parts);
        }
