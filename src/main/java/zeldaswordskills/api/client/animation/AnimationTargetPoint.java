...
public class AnimationTargetPoint extends AnimationTimed {
     ...
     */
    public AnimationTargetPoint(ModelRenderer part, RotationAxis axis, float targetPosition, int startFrame,
        int endFrame) {
     ...
     * @param targetPosition Target rotation point expected by the end of the animation, usually relative to the
     *                       original position
     * @param relative       True to add the model part's original rotation point value to the targetOffset
     */
    public AnimationTargetPoint(ModelRenderer part, RotationAxis axis, float targetPosition, int startFrame,
        int endFrame, boolean relative) {
    ...
    /**
     * Returns the amount to add to the rotation point based on the current value and
     * {@link #getProgress(int, float, float) progress}
     */
