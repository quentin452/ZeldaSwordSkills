 ...
 *
 */
public class EntityAIDynamic<T extends EntityCreature & IEntityDynamic> extends EntityAIBase
    implements IEntityDynamicAI {
    ...
    public boolean continueExecuting() {
        if (actor.getActiveActions()
            .isEmpty()
            || !actor.getActiveActions()
                .contains(action)) {
