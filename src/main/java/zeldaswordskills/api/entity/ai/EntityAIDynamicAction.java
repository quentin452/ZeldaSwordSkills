...
public class EntityAIDynamicAction<T extends EntityCreature & IEntityDynamic> extends EntityAIDynamic<T> {
    ...
    protected boolean canPerformAction() {
        if (target == null || !target.isEntityAlive()) {
            ...
            return false;
        } else if (require_sight && !actor.getEntitySenses()
            .canSee(target)) {
                return false;
            } else if (!checkRange()) {
                return false;
     ...
     *
     */
    public static class EntityAIDynamicCustomTarget<T extends EntityCreature & IEntityDynamic & IEntityCustomTarget>
        extends EntityAIDynamicAction<T> {
