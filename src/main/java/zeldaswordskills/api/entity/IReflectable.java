...
public interface IReflectable extends IProjectile {
     ...
     * <br>
     * Consider returning {@link IReflective#getReflectChance(ItemStack, EntityPlayer, DamageSource, float)
     * IReflective#getReflectChance} if appropriate.
     * 
     ...
     *         <br>
     *         Returning a negative value will result in the default randomized variance being used.
     */
