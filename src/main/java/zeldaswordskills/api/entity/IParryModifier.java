...
public interface IParryModifier {
     ...
     * 
     * @param entity Attacking entity who may be disarmed: either the instance of IParryModifier, or the entity wielding
     *               the stack
     * @param stack  ItemStack which may be disarmed: either the instance of IParryModifier, or the item held by the
     *               entity
     ...
     * 
     * @param entity Defending entity attempting to disarm: either the instance of IParryModifier, or the entity
     *               wielding the stack
     * @param stack  ItemStack being used to disarm: either the instance of IParryModifier, or the item held by the
     *               entity
