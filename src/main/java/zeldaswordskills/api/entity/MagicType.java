...
public enum MagicType {
    ...
    private MagicType(String name, EnumDamageType damageType, boolean affectsBlocks, String texture, String moveSound,
        String trailingParticle) {
    ...
    public boolean affectsBlocks(World world, EntityLivingBase caster) {
        return affectsBlocks && (caster instanceof EntityPlayer || world.getGameRules()
