...
public interface ISongTeacher {
     ...
     * @return a {@link TeachingResult#TeachingResult TeachingResult} object to determine what will happen, or null to
     *         proceed directly to {@code Entity#interact}
     */
    ...
    public static class TeachingResult {
         ...
         *                    return true from {@code Entity#interact} if the player is holding an
         *                    {@code ItemInstrument}
         */
