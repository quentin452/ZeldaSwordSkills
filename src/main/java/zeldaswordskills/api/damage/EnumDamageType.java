...
public enum EnumDamageType {
            ...
            case COLD:
                entity.addPotionEffect(
                    new PotionEffect(
                        ...
                        (int) (damage * source.getDuration(this)),
                        source.getAmplifier(this)));
                break;
            case QUAKE:
                entity.addPotionEffect(
                    new PotionEffect(
                        ...
                        source.getAmplifier(this)));
                entity.addPotionEffect(
                    new PotionEffect(Potion.moveSlowdown.id, (int) (damage * source.getDuration(this)), 0)); // only
                                                                                                             // ever
                                                                                                             // Slow I
                break;
            case STUN:
                if (source instanceof IDamageSourceStun) {
                    ...
                    stunTime += entity.worldObj.rand.nextInt((int) (Math.max(damage, 1.0F) * modifier))
                        - entity.worldObj.rand.nextInt(stunTime / 2);
                    if (!(entity instanceof EntityPlayer) || stunSource.canStunPlayers()) {
                        ZSSEntityInfo.get(entity)
                            .stun(stunTime, stunSource.alwaysStuns());
                    }
                }
                break;
            default:
    ...
    public static final Map<EnumDamageType, Buff> damageResistMap = new EnumMap<EnumDamageType, Buff>(
        EnumDamageType.class);

    /** Map of damage types to weakness types */
    public static final Map<EnumDamageType, Buff> damageWeaknessMap = new EnumMap<EnumDamageType, Buff>(
        EnumDamageType.class);
