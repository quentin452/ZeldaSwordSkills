...
public interface IReflective {
     ...
     * <br>
     * Called automatically only for non-{@link IReflectable} projectiles; IReflectables call this method at their
     * discretion.
     * <br>
     * WARNING: Do not call {@link IReflectable#getReflectChance(ItemStack, EntityPlayer, DamageSource, float)
     * IReflectable#getReflectChance} chance from here unless you want an infinite loop.
     * 
