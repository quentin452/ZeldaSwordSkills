...
public class ModelDekuFire extends ModelDekuBaba {
    ...
    public ModelDekuFire() {
        ...
        SPIT_ANIMATION = new ImmutableList.Builder<IAnimation>().add(
            new AnimationTargetAngle(stem1, RotationAxis.X, -35.0F, 0, 3, true).setProgressType(IProgressType.SQUARED))
            .add(
                new AnimationTargetAngle(stem1, RotationAxis.X, 20.0F, 3, 7, true).setProgressType(IProgressType.CUBED))
            ...
            .add(
                new AnimationTargetAngle(stem2, RotationAxis.X, 20.0F, 3, 7, true).setProgressType(IProgressType.CUBED))
            ...
            .add(
                new AnimationTargetAngle(stem3, RotationAxis.X, 50.0F, 0, 3, true)
                    .setProgressType(IProgressType.SQUARED))
            .add(
                new AnimationTargetAngle(stem3, RotationAxis.X, 15.0F, 3, 7, true).setProgressType(IProgressType.CUBED))
            ...
            .add(
                new AnimationTargetAngle(head_base, RotationAxis.X, 50.0F, 0, 3, true)
                    .setProgressType(IProgressType.SQUARED))
            .add(
                new AnimationTargetAngle(head_base, RotationAxis.X, 45.0F, 3, 7, true)
                    .setProgressType(IProgressType.CUBED))
            .add(new AnimationTargetAngle(head_base, RotationAxis.X, 60.0F, 12, 15, true).setAllowOffset(false))
            .add(
                new AnimationWaveTimed.AnimationWaveTimedSin(RotationAxis.Y, 7, 12, 1.5F, 0.3F, 0.15F, head_base)
                    .setAllowSpeed(false))
            .add(
            ...
            .add(
                new AnimationTargetAngle(mouth_lower, RotationAxis.X, -25.0F, 12, 15, true).setAllowInversion(false)
                    .setAllowOffset(false))
            .add(
                new AnimationTargetAngle(mouth_base_upper, RotationAxis.X, -60.0F, 0, 5, true).setAllowInversion(false))
            .add(
        ...
        SEVER_ANIMATION = new ImmutableList.Builder<IAnimation>()
            ...
            .add(
                new AnimationTargetAngle(gland_copy[0], RotationAxis.X, -405.0F, 12, 16, true).setAllowInversion(false))
    ...
    protected void applyAnimations(EntityDekuFire entity, float par2, float par3, float partialTick) {
        ...
        if (frame > 0) {
            ...
            IAnimation.Helper
                .applyAnimation(SEVER_ANIMATION, frame, partialTick, 1.0F, 1.0F, 0.0F, entity.gland_timer < 0);
        }
    }
