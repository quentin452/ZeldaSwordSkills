    ...
    public void drawScreen(int mouseX, int mouseY, float f) {
        ...
        for (int i = 0; (i + i1) < melody.size(); ++i) {
            ...
            RenderHelperQ.drawTexturedRect(
                ...
                guiTop + dy,
                xSize,
                PlayableNote.getOrdinalFromNote(note) * NOTE_SIZE,
                NOTE_SIZE,
                NOTE_SIZE,
                fullX,
                fullY);
