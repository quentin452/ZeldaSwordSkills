...
public class GuiPedestal extends GuiContainer {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        String s = pedestal.hasCustomInventoryName() ? pedestal.getInventoryName()
            : I18n.format(pedestal.getInventoryName());
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        ...
        int meta = pedestal.getWorldObj()
            .getBlockMetadata(pedestal.xCoord, pedestal.yCoord, pedestal.zCoord);
