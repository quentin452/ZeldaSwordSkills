...
public class RenderCustomArrow extends Render {
    ...
    public void renderArrow(EntityArrowCustom arrow, double dx, double dy, double dz, float yaw, float partialTick) {
        ...
        GL11.glRotatef(
            arrow.prevRotationYaw + (arrow.rotationYaw - arrow.prevRotationYaw) * partialTick - 90.0F,
            0.0F,
            1.0F,
            0.0F);
        GL11.glRotatef(
            arrow.prevRotationPitch + (arrow.rotationPitch - arrow.prevRotationPitch) * partialTick,
            0.0F,
            0.0F,
            1.0F);
