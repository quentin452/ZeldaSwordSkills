...
public class RenderEntityWhip extends Render {
    ...
    protected void renderLeash(EntityWhip whip, double x, double y, double z, float yaw, float partialTick) {
        ...
        if (entity != null) {
            ...
            double d12 = func_110828_a(
                (double) whip.prevRotationYaw,
                (double) whip.prevRotationPitch,
            ...
            if (whip.isInGround()) {
                whip.posX = whip.getDataWatcher()
                    .getWatchableObjectFloat(EntityWhip.HIT_POS_X);
                whip.posY = whip.getDataWatcher()
                    .getWatchableObjectFloat(EntityWhip.HIT_POS_Y);
                whip.posZ = whip.getDataWatcher()
                    .getWatchableObjectFloat(EntityWhip.HIT_POS_Z);
