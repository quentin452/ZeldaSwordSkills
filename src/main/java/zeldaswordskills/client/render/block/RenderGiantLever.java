...
public class RenderGiantLever implements ISimpleBlockRenderingHandler {
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId,
        ...
        switch (i1) {
            case 0:
                renderer.setRenderBounds(0.125F, 0.625F, 0.2F, 0.875F, 1.0F, 0.8F);
                break;
            case 1:
                renderer.setRenderBounds(0.0F, 0.125F, 0.2F, 0.375F, 0.875F, 0.8F);
                break;
            case 2:
                renderer.setRenderBounds(0.625F, 0.125F, 0.2F, 1.0F, 0.875F, 0.8F);
                break;
            case 3:
                renderer.setRenderBounds(0.2F, 0.125F, 0.0F, 0.8F, 0.875F, 0.375F);
                break;
            case 4:
                renderer.setRenderBounds(0.2F, 0.125F, 0.625F, 0.8F, 0.875F, 1.0F);
                break;
            case 5:
                renderer.setRenderBounds(0.2F, 0.0F, 0.125F, 0.8F, 0.375F, 0.875F);
                break;
            case 6:
                renderer.setRenderBounds(0.125F, 0.0F, 0.2F, 0.875F, 0.375F, 0.8F);
                break;
            case 7:
                renderer.setRenderBounds(0.2F, 0.625F, 0.125F, 0.8F, 1.0F, 0.875F);
                break;
        }
