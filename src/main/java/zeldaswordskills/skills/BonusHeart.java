...
public class BonusHeart extends SkillPassive {
    ...
    private static final AttributeModifier bonusHeartModifier = (new AttributeModifier(
        bonusHeartUUID,
        "ZSS Bonus Heart",
        2.0D,
        0)).setSaved(true);
    ...
    protected void levelUp(EntityPlayer player) {
        ...
        AttributeModifier newModifier = (new AttributeModifier(bonusHeartUUID, "Bonus Heart", level * 2.0D, 0))
            .setSaved(true);
