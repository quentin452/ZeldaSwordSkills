...
public class DashImpactPacket extends AbstractServerMessage<DashImpactPacket> {
    ...
    protected void process(EntityPlayer player, Side side) {
        Dash dash = (Dash) ZSSPlayerSkills.get(player)
            .getActiveSkill(SkillBase.dash);
        if (dash != null && dash.isActive()) {
            ...
            if (hitType == MovingObjectType.ENTITY.ordinal()) {
                ...
                if (entityHit != null) {
                    ...
                    ZSSMain.logger
                        .warn("Could not retrieve valid entity for MovingObjectPosition while handling Dash Packet!");
                }
            }
