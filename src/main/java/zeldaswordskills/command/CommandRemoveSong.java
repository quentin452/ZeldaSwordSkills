    ...
    public void processCommand(ICommandSender sender, String[] args) {
        ...
        if (("all").equals(args[1])) {
            ...
            if (player != commandSender) {
                PlayerUtils
                    .sendTranslatedChat(player, "commands.removesong.notify.all", commandSender.getCommandSenderName());
            }
        } else {
