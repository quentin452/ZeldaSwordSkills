        ...
        if (type != null) {
            ...
            if (rand.nextFloat() < 0.2F && !areStructuresWithinRange(room, Config.getNetherMinBossDistance())) {
                ...
                if (posY > 16 && room.generate(this, world, rand, posX, posY, posZ)) {
                    // LogHelper.log(Level.INFO, "Nether Boss room of type " + type.toString() + " successfully
                    // generated at " + room.getBoundingBox().toString());
                    onStructureGenerated(world, room);
                } else {
                    // LogHelper.log(Level.INFO, "Nether Boss room of type " + type.toString() + " failed to generate at
