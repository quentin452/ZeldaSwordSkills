...
public abstract class AbstractZeldaSong {
    ...
    private void notifySongEntities(World world, EntityPlayer player, int power, int radius) {
        ...
        List<ISongEntity> entities = world.getEntitiesWithinAABB(
            ISongEntity.class,
            player.boundingBox.expand(radius, (double) radius / 2.0D, radius));
